...
<div class="form-wrapper">
    <div class="form-title">
        <i class="fas fa-edit" style="color: #2c6b9e;"></i> Edit Keluarga
    </div>
    <div class="form-subtitle">
        <i class="fas fa-chevron-right" style="font-size: 10px; color: #8a94a6;"></i> 
        Edit data keluarga terdaftar di Posyandu Bougenvil Belik
    </div>
    ...
    <form method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label>No KK <span style="color: #dc2626;">*</span></label>
                    <input type="text" name="no_kk" class="form-control" required
                           value="<?= htmlspecialchars($data['no_kk']) ?>" placeholder="Masukkan No KK">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Kepala Keluarga <span style="color: #dc2626;">*</span></label>
                    <input type="text" name="nama_kepala_keluarga" class="form-control" required
                           value="<?= htmlspecialchars($data['nama_kepala_keluarga']) ?>" placeholder="Nama Kepala Keluarga">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nik_ayah" class="form-control"
                           value="<?= htmlspecialchars($data['nik_ayah']) ?>" placeholder="NIK Ayah">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ayah" class="form-control"
                           value="<?= htmlspecialchars($data['nama_ayah']) ?>" placeholder="Nama Ayah">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nik_ibu" class="form-control"
                           value="<?= htmlspecialchars($data['nik_ibu']) ?>" placeholder="NIK Ibu">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ibu" class="form-control"
                           value="<?= htmlspecialchars($data['nama_ibu']) ?>" placeholder="Nama Ibu">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <label>Alamat</label>
            <textarea name="alamat" rows="3" class="form-control" placeholder="Alamat lengkap"><?= htmlspecialchars($data['alamat']) ?></textarea>
        </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="rt" class="form-control"
                           value="<?= htmlspecialchars($data['rt']) ?>" placeholder="RT">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="rw" class="form-control"
                           value="<?= htmlspecialchars($data['rw']) ?>" placeholder="RW">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="desa" class="form-control"
                           value="<?= htmlspecialchars($data['desa']) ?>" placeholder="Desa/Kelurahan">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="kecamatan" class="form-control"
                           value="<?= htmlspecialchars($data['kecamatan']) ?>" placeholder="Kecamatan">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp" class="form-control"
                           value="<?= htmlspecialchars($data['no_hp']) ?>" placeholder="Nomor HP">
                </div>
            </div>
        </div>
