...
if (isset($_POST['update'])) {
    ...
    if (empty($errors)) {
        ...
        if ($result) {
            echo "
            <script>
                alert('Data imunisasi berhasil diupdate');
                window.parent.location='index.php?url=master_imunisasi';
            </script>
            ";
        } else {
...
<div class="form-wrapper">
    <div class="form-title">
        <i class="fas fa-edit" style="color: #e8a317;"></i> Edit Imunisasi
    </div>
    ...
    <form method="POST">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_imunisasi" class="form-control" required 
                           value="<?= htmlspecialchars($data['nama_imunisasi']) ?>" maxlength="100">
        ...
        <div class="form-group">
            ...
            <textarea name="keterangan" class="form-control form-control-textarea" placeholder="Masukkan keterangan (opsional)"><?= htmlspecialchars($data['keterangan'] ?? '') ?></textarea>
