...
--
-- Host: localhost:3306
-- Generation Time: Jun 15, 2026 at 03:53 PM
...
(1, '2026-05-01', 'Balai Desa Kedungwaru', '-', 1, 1, '2026-04-30 18:33:35', 'scheduled'),
(2, '2026-06-06', 'PKD Kedungwaru', '-', 2, 1, '2026-06-07 14:17:32', 'scheduled'),
(3, '2026-06-12', 'Posyandu Kedungwaru', '', 3, 1, '2026-06-07 14:27:10', 'scheduled');
...
(3, 4, 1, 'hadir', 1, '2026-06-07 13:32:32'),
(4, 2, 1, 'hadir', 1, '2026-06-07 13:32:32'),
(5, 4, 3, 'hadir', 1, '2026-06-07 14:37:17'),
(6, 2, 3, 'hadir', 1, '2026-06-07 14:37:17');
...
INSERT INTO `pemeriksaan` (`id`, `id_anak`, `id_kegiatan`, `umur_bulan`, `berat_badan`, `tinggi_badan`, `lingkar_kepala`, `status_gizi`, `catatan`, `diukur_oleh`, `divalidasi_oleh`, `status_validasi`, `created_at`) VALUES
(2, 4, 3, 52, 30.00, 50.00, 89.00, 'Baik', 'jkk', 1, NULL, 'pending', '2026-06-07 17:54:55'),
(3, 2, 3, 315, 88.00, 100.00, 200.00, 'Baik', 'lk', 1, NULL, 'pending', '2026-06-07 17:54:55');
...
(1, 'wisnu', 'wisnu@gmail.com', '$2y$10$2m7TbQ5U9qqS4KvmxFWRDuVXKQ.l/MmG5MiViSCTmiguKNXtDYTQe', 'admin', '2026-04-27 17:18:14', '2026-04-28 16:32:00');
...
ALTER TABLE `pemeriksaan`
  ...
  ADD CONSTRAINT `pemeriksaan_ibfk_4` FOREIGN KEY (`divalidasi_oleh`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
